@extends('layouts.app', ['title' => __('User Profile'), 'page' => 'profile'])

@section('content')
    @include('users.partials.header', [
        'title' => __('Olá') . ' '. auth()->user()->name,
        'description' => __('Esta é a sua página de perfil. Você pode gerenciar seus dados'),
        'class' => 'col-lg-12'
    ])
                    ...
                    <div class="row justify-content-center">
                        <div class="col-lg-3 order-lg-2">
                            <div class="card-profile-image">
                                <a href="#">
                                    <img src="{{ asset('argon') }}/img/theme/team-4-800x800.jpg" class="rounded-circle" style="top: -60px;">
                                </a>
                            </div>
                        </div>
                    </div>
                        ...
                        <form method="post" action="" autocomplete="off">
                            ...
                            <div class="pl-lg-4">
                                <div class="form-group{{ $errors->has('name') ? ' has-danger' : '' }}">
                                    ...
                                    <input type="text" name="name" id="input-name" class="form-control form-control-alternative{{ $errors->has('name') ? ' is-invalid' : '' }}" placeholder="{{ __('Nome') }}" value="{{ old('name', auth()->user()->name) }}" required disabled>
